...
public class contractDetailServlet extends AbstractServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int contractId = Integer.parseInt(request.getParameter(UrlParameters.CONTRACT_DETAIL_ID_PARAMETER.getParameter()));
            contract = contractEntityDAO.getContractByID(contractId);
